...
import { ExpandingBubble } from "@/shared/ui/ExpandingBubble";
import { SignalDot } from "@/shared/ui/SignalDot";
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed inset-0 z-90 backdrop-blur-[2px] bg-black/5"
                    />
                )}
            </AnimatePresence>

            {/* Меню */}
            <div ref={wrapperRef} className="fixed left-4 bottom-8 md:bottom-auto md:top-4 z-100">
                <ExpandingBubble
                    layoutId="task-nav"
                    isOpen={isOpen}
                    onOpen={() => setIsOpen(true)}
                    collapsedContent={<SignalDot size={10} />}
                    expandedContent={
